...
* TODO: m5.4
* All other models are replicated and checked against the book. There are small numerical difference, probably due to the difference between `quap` and `Stan`.
