...
In the book, models m7.1 to m7.6 are estimated using `quap` rather than `Stan`. My estimates are similar for models m7.1 to 7.3, but diverge somewhat for the others. Also, my compatibility intervals for $\mu$ are very different. Not sure what the problem is.
